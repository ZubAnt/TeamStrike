...
StartMenuData::StartMenuData(cocos2d::Layer *layer, Director* director)
{
    _director = director;
    _layer = layer;
...
void StartMenuData::set_background()
{
...
void StartMenuData::set_header_Label()
{
...
void StartMenuData::set_MenuLabel(const std::string &text, float x, float y, const ccMenuCallback &callback)
{
...
void StartMenuData::set_style_MenuLabel(Label *label)
{
...
void StartMenuData::set_style_header_label(Label *label)
{
