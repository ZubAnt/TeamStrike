...
ExitMenuData::ExitMenuData(cocos2d::Layer *layer, Director* director)
{
    _director = director;
    _layer = layer;
...
void ExitMenuData::set_background()
{
...
void ExitMenuData::set_header_Label()
{
...
void ExitMenuData::set_label(const std::string name_label,float fontSize,float x_position, float y_position )
{
...
void ExitMenuData::set_MenuLabel(const std::string &text, float x, float y, const ccMenuCallback &callback)
{
    auto label = create_lable(text, _visibleSize.width / 25);
...
void ExitMenuData::set_style_MenuLabel(Label *label)
{
...
void ExitMenuData::set_style_header_label(Label *label)
{
